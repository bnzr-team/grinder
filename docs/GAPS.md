...
>
> Last updated: 2026-03-01 (main @ 418a571)
...
- **Account Syncer** — `docs/15_ACCOUNT_SYNC_SPEC.md` ↔ `src/grinder/account/syncer.py` (247 lines). Positions + open orders. Launch-15 (#224-228).
